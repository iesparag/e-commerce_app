...
const userAddressRoutes = require("./userRoutes/address.user.routes.js");
...
const orderBuyerRouter = require("./buyerRoutes/order.buyer.routes.js");
const paymentBuyerRouter = require("./buyerRoutes/payment.buyer.routes.js");

module.exports = [
    { path: "/api/v1/users", handler: userRouter },
    { path: "/api/v1/user-address", handler: userAddressRoutes },
    ...
    { path: "/api/v1/buyer/orders", handler: orderBuyerRouter },
    { path: "/api/v1/buyer/payment", handler: paymentBuyerRouter },
];
